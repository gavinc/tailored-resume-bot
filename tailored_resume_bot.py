...
Original file is located at
    https://colab.research.google.com/drive/1ACShlegW1IR-4TSE2bfI1Wz_-gAsvUlv
"""

!pip install gradio openai==0.28 PyPDF2
...
# Set your OpenAI API key securely from the Colab secrets
